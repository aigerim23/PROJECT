...
export const translations = {
  ...
  description: [
    ...
    "«С 2025 года обеспечиваем бесперебойную поставку запасных частей для железнодорожных вагонов на текущий отцепочный ремонт вагонов, принадлежащих АО «НК «Қазақстан темір жолы»»»."
  ],
