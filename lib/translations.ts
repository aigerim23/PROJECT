...
about: {
 ...
 description: "Мы обеспечиваем бесперебойную работу вагонного парка, поставляя сертифицированное литье и детали ходовых частей. Каждое изделие проходит строгий технический контроль.\n\nВ наш опыт входит успешное выполнение работ по деповскому ремонту грузовых вагонов собственности АО «KTZ Express». Также обеспечиваем бесперебойную поставку запасных частей для ЖД вагонов в 2025 году на текущий отцепочный ремонт (ТОР) вагонов собственности АО «НК «КТЖ».",
