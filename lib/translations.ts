...
export const translations = {
  ru: {
    ...
    about: {
      ...
      description:
        " Надежность и качество в каждой детали: обслуживание вагонного парка.Мы обеспечиваем бесперебойную работу железнодорожного транспорта, специализируясь на поставках сертифицированного литья и комплектующих для ходовых частей. Каждое изделие в нашем ассортименте проходит строгий технический контроль, что гарантирует безопасность и долговечность эксплуатации.Наш опыт и достижения: Ремонт и сервис: Успешно реализовали проекты по деповскому ремонту грузовых вагонов для АО «KTZ Express». Оперативность поставок: В 2025 году обеспечили своевременное снабжение запчастями для текущего отцепочного ремонта (ТОР) вагонов собственности АО «НК «КТЖ». Мы понимаем ценность времени в логистике, поэтому делаем ставку на высокие стандарты качества и четкое соблюдение сроков поставок.",
